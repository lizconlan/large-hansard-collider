...
describe LordsDebatesParser do
  ...
  context "when handling Member Introductions within Debates" do
    ...
    it "should correctly recognise the Member Introductions" do
      ...
      preamble = Preamble.new(:ident => "2099-01-01_hansard_l_d_000001")
      Preamble.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_l_d_000001").returns(preamble)
      preamble.expects(:title=).with('House of Lords')
      preamble.expects(:component=).with(@component)
      preamble.expects(:url=).with("#{@url}\#11011158000521")
      preamble.expects(:sequence=).with(1)
      preamble.expects(:columns=).with(["1285"])
      
      ncpara1 = NonContributionPara.new(:ident => "2099-01-01_hansard_l_d_000001_p000001")
      NonContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_l_d_000001_p000001").returns(ncpara1)
      ...
      member_intro = MemberIntroduction.new(:ident => "2099-01-01_hansard_l_d_000002")
      MemberIntroduction.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_l_d_000002").returns(member_intro)
      member_intro.expects(:title=).with("Introduction: Lord True")
      member_intro.expects(:members=).with(["Lord True"])
      
      timestamp = Timestamp.new(:ident => "2099-01-01_hansard_l_d_000002_p000001")
 ...
 NonContributionPara.expects(:find_or_create_by).with(ident: '2099-01-01_hansard_l_d_000002_p000002').returns(ncpara)
      ...
      MemberIntroduction.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_l_d_000003").returns(member_intro)
  ...
  #     
  #     ncpara = NonContributionPara.new
  #     NonContributionPara.expects(:find_or_create_by).with(ident: '2099-01-01_hansard_c_d_000001_p000003').returns(ncpara)
  #     ncpara.expects(:content=).with("Prayers")
  #     
  #     ncpara = NonContributionPara.new
  ...
  #     preamble.expects(:ident).at_least_once.returns('2099-01-01_hansard_c_d_000002')
  ...
  #     Question.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003").returns(question)
  #     question.expects(:ident).at_least_once.returns("2099-01-01_hansard_c_d_000003")
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000005").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000006").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000007").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000008").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000009").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000010").returns(contribution)
  ...
  #     question = Question.new
  #     Question.any_instance.stubs(:paragraphs).returns([])
  #     Question.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000004").returns(question)
  #     question.expects(:ident).at_least_once.returns("2099-01-01_hansard_c_d_000004")
  #     question.expects(:department=).with("Foreign and Commonwealth Office")
  #     question.expects(:title=).with("Nuclear Non-proliferation and Disarmament")
  #     question.expects(:number=).with("66858")
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000004_p000001").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000004_p000002").returns(contribution)
  ...
  #     
  #     contribution = ContributionPara.new
  #     ContributionPara.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000003_p000001").returns(contribution)
  #     contribution.expects(:content=).with("T1. [66880] Harriett Baldwin (West Worcestershire) (Con): If he will make a statement on his departmental responsibilities.")
  #     contribution.expects(:member=).with("Harriett Baldwin")
  #     contribution.expects(:speaker_printed_name=).with("Harriett Baldwin")
  #     
  ...
  #     
  #     debate = Debate.new
  #     Debate.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000004").returns(debate)
  #     debate.expects(:ident).at_least_once.returns("2099-01-01_hansard_c_d_000004")
  #     debate.stubs(:paragraphs).returns([])
  #     
  #     timestamp = Timestamp.new
  #     Timestamp.expects(:find_or_create_by).with(ident: "2099-01-01_hansard_c_d_000004_p000001").returns(timestamp)
  ...
  #     
  #     NonContributionPara.expects(:find_or_create_by).with(ident: '2099-01-01_hansard_c_d_000002_p000002').returns(ncpara)
  ...
  #     
  #     NonContributionPara.expects(:find_or_create_by).with(ident: '2099-01-01_hansard_c_d_000002_p000005').returns(ncpara)
  #     ncpara.expects(:content=).with("Question put, That the amendment be made.")
  #     
  #     division = Division.new
  #     Division.expects(:find_or_create_by).with(ident: '2099-01-01_hansard_c_d_000002_p000006').returns(division)
